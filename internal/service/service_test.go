...
// 		t.Error("WorkerPool.Proccess() should be called")
// 	}
...
// 		err := service.Proccess(context.Background(), "image1.jpg")
// 		if err != nil {
...
// 		// Заполняем очередь
// 		service.Proccess(context.Background(), "image1.jpg")

// 		ctx, cancel := context.WithCancel(context.Background())
// 		cancel()

// 		err := service.Proccess(ctx, "image2.jpg")
...
// 		err = service.Proccess(context.Background(), "image2.jpg")
...
// 		// Добавляем задачу
// 		service.Proccess(context.Background(), "slow-image.jpg")
...
// 		err := service.Proccess(context.Background(), path)
// 		if err != nil {
...
// 		go func(index int) {
// 			defer wg.Done()
// 			err := service.Proccess(context.Background(), fmt.Sprintf("image_%d.jpg", index))
...
// 	for i := 0; i < 10; i++ {
// 		err := service.Proccess(context.Background(), fmt.Sprintf("image_%d.jpg", i))
// 		if err == errors.ErrQueueTasksFull {
// 			queueFullCount++
// 		} else if err != nil {
